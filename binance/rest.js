...
import {binanceRestSchema, binanceWSSchema, keyWSSchema} from "./schema";

/*
* https://github.com/binance-exchange/binance-official-api-docs/blob/master/rest-api.md
*	Example: api.time().then(data => console.log(data))
*	Example: api.depth({symbol: 'ETHBTC', limit: 100}).then(data => console.log(data))
 */
